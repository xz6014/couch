...
public class UltimateIK : MonoBehaviour {
    ...
    public static Model BuildModel(Model reference, Transform root, params Transform[] objectives) {
        ...
        // skeleton.AvoidBoneLimits = reference.AvoidBoneLimits;
        skeleton.RootTranslationX = reference.RootTranslationX;
        skeleton.RootTranslationY = reference.RootTranslationY;
        skeleton.RootTranslationZ = reference.RootTranslationZ;
        return skeleton;
    }
